    ...
    case 'popup':
        ...
        if ( isset( $content ) && !empty($content) ) {
            ...
            ?>
                                    ...
                                    <p><?php 
            echo  apply_filters( 'wpop_offer_popup_content', $content, $instance ) ;
            ?></p>
    ...
    case 'wellcome_matt':
        ...
        if ( isset( $content ) && !empty($content) ) {
            ...
            ?>
                                    ...
                                    <p><?php 
            echo  apply_filters( 'wpop_offer_wellcome_matt_content', $content, $instance ) ;
            ?></p>
    ...
    case 'slide_in':
        ...
        if ( isset( $content ) && !empty($content) ) {
            ...
            ?>
                            ...
                            <p><?php 
            echo  apply_filters( 'wpop_offer_slide_in_content', $content, $instance ) ;
            ?></p>
    ...
    default:
        ...
        if ( isset( $content ) && !empty($content) ) {
            ...
            ?>
                            ...
                            <p><?php 
            echo  apply_filters( 'wpop_offer_bar_content', $content, $instance ) ;
            ?></p>
