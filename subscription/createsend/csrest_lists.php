...
if ( ! class_exists( 'CS_REST_Lists' ) ) {
	class CS_REST_Lists extends CS_REST_Wrapper_Base {
		...
		function __construct(
			$list_id, $auth_details, $protocol = 'https', $debug_level = CS_REST_LOG_NONE, $host = 'api.createsend.com', $log = null, $serialiser = null, $transport = null
		) {
		...
		function update_custom_field( $key, $custom_field_details ) {
			return $this->put_request( $this->_lists_base_route . 'customfields/' . rawurlencode( $key ) . '.json', $custom_field_details );
		}
		...
		function get_active_subscribers(
			$added_since = '', $page_number = null, $page_size = null, $order_field = null, $order_direction = null, $include_tracking_pref = null
		) {

			return $this->get_request_paged( $this->_lists_base_route . 'active.json?date=' . urlencode( $added_since ), $page_number, $page_size, $order_field, $order_direction, $include_tracking_pref );
		}
		...
		function get_unconfirmed_subscribers(
			...
			return $this->get_request_paged( $this->_lists_base_route . 'unconfirmed.json?date=' . urlencode( $added_since ), $page_number, $page_size, $order_field, $order_direction, $include_tracking_pref );
		}
		 ...
		 * }
		 */
		function get_bounced_subscribers(
			$bounced_since = '', $page_number = null, $page_size = null, $order_field = null, $order_direction = null, $include_tracking_pref = null
		) {

			return $this->get_request_paged( $this->_lists_base_route . 'bounced.json?date=' . urlencode( $bounced_since ), $page_number, $page_size, $order_field, $order_direction, $include_tracking_pref );
		}
		 ...
		 * }
		 */
		function get_unsubscribed_subscribers(
			$unsubscribed_since = '', $page_number = null, $page_size = null, $order_field = null, $order_direction = null, $include_tracking_pref = null
		) {

			return $this->get_request_paged( $this->_lists_base_route . 'unsubscribed.json?date=' . urlencode( $unsubscribed_since ), $page_number, $page_size, $order_field, $order_direction, $include_tracking_pref );
		}
		 ...
		 * }
		 */
		function get_deleted_subscribers(
			$deleted_since = '', $page_number = null, $page_size = null, $order_field = null, $order_direction = null, $include_tracking_pref = null
		) {

			return $this->get_request_paged( $this->_lists_base_route . 'deleted.json?date=' . urlencode( $deleted_since ), $page_number, $page_size, $order_field, $order_direction, $include_tracking_pref );
		}
