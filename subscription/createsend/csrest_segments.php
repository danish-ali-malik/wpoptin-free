...
if ( ! class_exists( 'CS_REST_Segments' ) ) {
	class CS_REST_Segments extends CS_REST_Wrapper_Base {
		...
		function __construct(
			$segment_id, $auth_details, $protocol = 'https', $debug_level = CS_REST_LOG_NONE, $host = 'api.createsend.com', $log = null, $serialiser = null, $transport = null
		) {
		...
		function get_subscribers(
			$subscribed_since = '', $page_number = null, $page_size = null, $order_field = null, $order_direction = null, $include_tracking_pref = null
		) {

			return $this->get_request_paged( $this->_segments_base_route . '/active.json?date=' . urlencode( $subscribed_since ), $page_number, $page_size, $order_field, $order_direction, $include_tracking_pref );
		}
	}
}