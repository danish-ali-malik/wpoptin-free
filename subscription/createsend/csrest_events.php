...
if ( ! class_exists( 'CS_REST_Events' ) ) {
	class CS_REST_Events extends CS_REST_Wrapper_Base {
		...
		function __construct(
			$auth_details, $client_id, $event_type, $protocol = 'https', $debug_level = CS_REST_LOG_NONE, $host = 'api.createsend.com', $log = null, $serialiser = null, $transport = null
		) {
		...
		private function setEventType( $event_type ) {
			...
			if ( strcmp( $event_type, "custom" ) !== 0 && strcmp( $event_type, "identify" ) !== 0 && strcmp( $event_type, "shopify" ) !== 0 ) {
