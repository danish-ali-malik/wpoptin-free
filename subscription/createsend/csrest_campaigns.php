 ...
 * along with accessing lists of campaign specific resources i.e reporting
 * statistics
 *
 * @author tobyb
 *
...
if ( ! class_exists( 'CS_REST_Campaigns' ) ) {
	class CS_REST_Campaigns extends CS_REST_Wrapper_Base {
		...
		function __construct(
			$campaign_id, $auth_details, $protocol = 'https', $debug_level = CS_REST_LOG_NONE, $host = 'api.createsend.com', $log = null, $serialiser = null, $transport = null
		) {
		...
		function get_recipients(
			$page_number = null, $page_size = null, $order_field = null, $order_direction = null
		) {
			return $this->get_request_paged( $this->_campaigns_base_route . 'recipients.json', $page_number, $page_size, $order_field, $order_direction );
		}
		...
		function get_bounces(
			...
			return $this->get_request_paged( $this->_campaigns_base_route . 'bounces.json?date=' . urlencode( $since ), $page_number, $page_size, $order_field, $order_direction );
		}
		...
		function get_opens(
			...
			return $this->get_request_paged( $this->_campaigns_base_route . 'opens.json?date=' . urlencode( $since ), $page_number, $page_size, $order_field, $order_direction );
		}
		...
		function get_clicks(
			...
			return $this->get_request_paged( $this->_campaigns_base_route . 'clicks.json?date=' . urlencode( $since ), $page_number, $page_size, $order_field, $order_direction );
		}
		...
		function get_unsubscribes(
			...
			return $this->get_request_paged( $this->_campaigns_base_route . 'unsubscribes.json?date=' . urlencode( $since ), $page_number, $page_size, $order_field, $order_direction );
		}
		...
		function get_spam(
			...
			return $this->get_request_paged( $this->_campaigns_base_route . 'spam.json?date=' . urlencode( $since ), $page_number, $page_size, $order_field, $order_direction );
		}
	}
}