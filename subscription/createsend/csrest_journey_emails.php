 ...
 * This class includes functions to retrieve journey information,such as
 * summaries, recipients, opens, clicks etc.
 *
 * @author peterv
 *
 */
...
if ( ! class_exists( 'CS_REST_JourneyEmails' ) ) {
	class CS_REST_JourneyEmails extends CS_REST_Wrapper_Base {
		...
		function __construct(
			$email_id, $auth_details, $protocol = 'https', $debug_level = CS_REST_LOG_NONE, $host = 'api.createsend.com', $log = null, $serialiser = null, $transport = null
		) {
		...
		function get_journey_recipients(
			$since = '', $page_number = null, $page_size = null, $order_field = null, $order_direction = null
		) {
			return $this->get_request_paged( $this->_journey_emails_base_route . '/recipients.json?date=' . urlencode( $since ), $page_number, $page_size, $order_field, $order_direction );
		}
		...
		function get_journey_opens(
			$since = '', $page_number = null, $page_size = null, $order_field = null, $order_direction = null
		) {
			return $this->get_request_paged( $this->_journey_emails_base_route . '/opens.json?date=' . urlencode( $since ), $page_number, $page_size, $order_field, $order_direction );
		}
		...
		function get_journey_clicks(
			$since = '', $page_number = null, $page_size = null, $order_field = null, $order_direction = null
		) {
			return $this->get_request_paged( $this->_journey_emails_base_route . '/clicks.json?date=' . urlencode( $since ), $page_number, $page_size, $order_field, $order_direction );
		}
		 ...
		 * }
		 */
		function get_journey_unsubscribes(
			$since = '', $page_number = null, $page_size = null, $order_field = null, $order_direction = null
		) {
			return $this->get_request_paged( $this->_journey_emails_base_route . '/unsubscribes.json?date=' . urlencode( $since ), $page_number, $page_size, $order_field, $order_direction );
		}
		...
		function get_journey_bounces(
			$since = '', $page_number = null, $page_size = null, $order_field = null, $order_direction = null
		) {
			return $this->get_request_paged( $this->_journey_emails_base_route . '/bounces.json?date=' . urlencode( $since ), $page_number, $page_size, $order_field, $order_direction );
		}
	}
